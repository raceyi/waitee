...
export class FaqPage {
  questions=[{hidden:true,
             ...
             {hidden:true,
               question:"충전힌트를 잘못 입력했어요",answer:"지갑탭->충전버튼 선택-> \"충전힌트 입력을 잊으셨나요? +\" 버튼 선택->계좌이체한 정보를 입력하실때 받는 통장 표시내용에 잘못 입력하신 충전힌트를 입력하시고 입금확인하기 버튼을 눌러주세요."},
             {hidden:true,
               question:"고의적으로 남의 입금액을 자신의 캐시에 충전할 순 없나요?",answer:"충전힌트를 입력하지 않으셨거나 실수로 다른 충전힌트를 입력하셨을 경우에 대비해 고객님이 입금정보를 기재하시고 충전을 확인할수 있도록 하고 있습니다. 그러나 세번 시도에서 모두 실패하면 해당 방법의 캐시 충전 기능이 정지됩니다. 또한 법적으로 본인의 입금이 아닌 금액에 대해 충전확인을 수행할경우 사기죄로 민형사상 피소가 가능합니다. 타킷은 소송의 주체가 될수 있으며 이러한 사건이 발생할 경우 반듯이 법적인 대응을 할것입니다."},
             {hidden:true,
             ...
             {hidden:true,
               question:"본인명의 휴대폰이 없어요.",answer:"타킷은 보안을 위해 충전힌트 설정시 본인확인 과정을 거치고 있습니다. 본인명의 휴대폰이 없을 경우 사용이 불가능합니다."},
             {hidden:true,
             ...
             {hidden:true,
               question: "무료 결제수수료가 어떤 의미인가요?",answer:"고객님의 온라인 결제시 카드 결제 수수료는 3.2%, 은행자동인출은 450원,가상계좌는 300원의 수수료가 지불됩니다. 타킷캐시는 여러분의 충전힌트 입력을 통해 외부수수료 없이 운영 됩니다. 상점주는 결제 수수료 없이 타킷 서비스 수수료 1%만을 지불하시면 됩니다."},
             ];
