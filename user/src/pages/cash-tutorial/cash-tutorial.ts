...
@ViewChild(Slides) slides: Slides;
    ...
    tutorials = [{img:'assets/imgs/cashGuideImg/cashGuide1.png', title:"온라인 계좌이체", 
                    contents:"온라인 계좌이체시 고객님의 캐시아이디를 입력해주세요. 대소문자를 구분하지 않으며 1회 10만원 이하의 금액만 충전가능합니다."},
    ...
    {img:'assets/imgs/cashGuideImg/cashGuide4.png',title:"입금 수동 확인",
      contents:"지갑 탭의 충전에서 ‘캐시 아이디 입력을 잊으셨나요?’를 클릭 후 이체정보를 채워주세요.받는통장 표시내용은 본인의 실명입니다."}];
