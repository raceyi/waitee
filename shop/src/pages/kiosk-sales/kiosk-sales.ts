...
/**
 * Generated class for the KioskSalesPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-kiosk-sales',
  templateUrl: 'kiosk-sales.html',
})
export class KioskSalesPage {
   ...
   if(this.startDate==undefined || this.endDate==undefined){
    ...
    // send getOrders request and update orders
     let body  = JSON.stringify({  takitId:this.storageProvider.myshop.takitId,option:"period",
      ...
      this.serverProvider.post("/kiosk/getSalesAndSatas",body).then((res:any)=>{
